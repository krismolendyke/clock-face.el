...
(ert-deftest clock-face--get-char-name ()
  ...
  (should (assoc (clock-face--get-char-name "01" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "01" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "02" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "02" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "03" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "03" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "04" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "04" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "05" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "05" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "06" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "06" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "07" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "07" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "08" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "08" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "09" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "09" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "10" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "10" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "11" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "11" "30") (ucs-names)))
  (should (assoc (clock-face--get-char-name "12" "00") (ucs-names)))
  (should (assoc (clock-face--get-char-name "12" "30") (ucs-names)))
